...
path =
 "D:/Julia_code_for_tomate_SDE_paper-main/Persistence_Rs0_noise_substracting/"
Data = CSV.read(path * "Data_persistence_substracting.csv", DataFrame)
...
CSV.write(path * "Data_mean_persistence_subs.csv",Data_Mean)
