...
parameters {
    ...
    real<lower = 0.0001, upper = 0.03> r_2;
    ...
    // real<lower = 0.0001, upper = 10> Lp0;
    // real<lower = 0.0001, upper = 10> Ip0;
    //real<lower = 0.0001, upper = 170> Iv0;
...
generated quantities {
    ...
    real lambda[n_obs]; 
    R_0 = (beta_p * beta_v * b /((b + r_1) * (gamma + gamma_f)* r_2))^(1/2);
    for (i in 1:n_obs){
      lambda[i] = y_hat[i,3];
    }
